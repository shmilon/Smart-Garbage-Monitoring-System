        ...
        <div class="card-hover-shadow-2x mb-3 card">
            ...
            <div class="scroll-area-lg">
                <div class="scrollbar-container ps ps--active-y">
                    ...
                    <div class="ps__rail-x" style="left: 0px; bottom: -293px;">
                        <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                    </div>
                    <div class="ps__rail-y" style="top: 293px; height: 400px; right: 0px;">
                        <div class="ps__thumb-y" tabindex="0" style="top: 170px; height: 230px;"></div>
                    </div>
                </div>
            </div>
